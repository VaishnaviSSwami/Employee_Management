...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="salary.php?id=<?php echo $id?>"">Salary</a></li>
				<li><a class="homeblack" href="leave.php?id=<?php echo $id?>"">Leave Status</a></li>
	...
	<div>
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Empolyee DetailBoard </h2>
    	<table>
